...
void main() {
  ...
  testWidgets('UI settings updates the persistent app text preset', (
    tester,
  ) async {
    final container = ProviderContainer();
    addTearDown(container.dispose);
    ...
    final selector = tester.widget<DropdownButton<AppTextScale>>(
      find.byType(DropdownButton<AppTextScale>),
    );
    selector.onChanged!(AppTextScale.large);
    await tester.pump();
